...
<div class="page-wrapper" v-if="champion">
    ...
    <div class="page-content">
        ...
        <div class="title-wrapper">
            ...
            <div class="title-part" >
                <template v-if="champion.counterPicks?.length > 0">
                    <span>Контрпики</span>
                    <div>
                        <img class="counter-pick-icon" :src="getChampionIcon(item)"
                             v-for="(item, index) in champion.counterPicks" alt="counter-pick-icon"
                             @click="openChampion(item)">
                    </div>
                </template>
            </div>
        </div>
                ...
                <div class="builds-wrapper" v-if="builds.length">
                    ...
                    <div class="side" v-if="currentBuild">
                        ...
                        <div class="build-items-wrapper" v-if="currentBuild.situationalItems?.length">
                            ...
                            <div class="build-items">
                                <game-item v-for="(item, index) in currentBuild.situationalItems"
                                           :name="item"></game-item>
                            </div>
                        </div>
                        <div class="build-items-wrapper" v-if="currentBuild.karmas?.length">
                            <span>Умения</span>
                            <div class="build-items">
                                <img class="karma" :src="getKarmaIcon(karma)"
                                     v-for="(karma, index) in currentBuild.karmas" :alt="karma">
                            </div>
                        </div>
